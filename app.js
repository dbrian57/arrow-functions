...
// `this` references the new `joe` object created using the `student` function
// 2. What is "this" when joe.scopeArrow() is invoked?
// `this` references the global window object in this function
// 3. Explain why "this" is different when an arrow function is used.
/*
In an arrow function, the `this` keyword is restricted to the scope of the
enclosing function. You should avoid using arrow functions with constructor functions.
*/
